...
{
    public partial class RSSBlogs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            xtwFeed.WriteElementString("title", BlogoSettings.RootPath + ":: Blog Feed");

            xtwFeed.WriteElementString("link", BlogoSettings.RootPath + "/View/Pages/Home.aspx");

            xtwFeed.WriteElementString("description", "The last blog entries from " + BlogoSettings.RootPath);

            xtwFeed.WriteElementString("copyright", "Copyright s3maphor3.org. All rights reserved.");

            List<Blogo.NET.Business.BlogEntry> rssEntries = BlogEntryManager.GetList(0, BlogoSettings.RSSPageSize);
